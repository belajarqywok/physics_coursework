...
% Last Modified by GUIDE v2.5 11-Dec-2022 16:34:31
...
h2 = str2double(get(handles.h2_input, 'string'));
...
set(handles.ek1_output, 'string', ek1);
...
% handles    structure with handles and user data (see GUIDATA)
% input
set(handles.v1_input, 'string', '0');
set(handles.h2_input, 'string', '0');
set(handles.m_input, 'string', '0');
% output
set(handles.ek2_output, 'string', '0');
set(handles.ek1_output, 'string', '0');
...
function h2_input_Callback(hObject, eventdata, handles)
% hObject    handle to h2_input (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of h2_input as text
%        str2double(get(hObject,'String')) returns contents of h2_input as a double


% --- Executes during object creation, after setting all properties.
function h2_input_CreateFcn(hObject, eventdata, handles)
% hObject    handle to h2_input (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
